  ...
  nodes: {
    ...
    ordered_list: {
      ...
      toDOM(node) {
        return [
          'ol',
          { start: node.attrs.order == 1 ? null : node.attrs.order, 'data-tight': node.attrs.tight ? 'true' : null },
          0,
        ];
      },
    },
    ...
    math_block: {
      ...
      toDOM(node) {
        ...
        dom.dataset.value = node.attrs.value;
        katex.render(node.attrs.value, dom, { throwOnError: false, displayMode: true });
        return dom;
      }
    }
  },
